            ...
            <div class="header-body">
                <div class="row">
                    <div class="col-md-6 mt-4 mb-2">
                        <a class="btn btn-secondary btn-rounded" data-toggle="modal" data-target="#tambahServis"> Tambah </a>
                    </div>
                            ...
                            <div class="table-responsive">
                                <table class="table align-items-center table-flush">
                                    <thead class="thead-light">
                                        ...
                                        <th style="min-width: 150px;" scope="col" class="sort" data-sort="Jenis Servis">Jenis Servis</th>
                                        ...
                                        <td>{{ $i++ }}</td>
                                            <th scope="row">
                                                ...
                                                <div class="btn-group" role="group" aria-label="Basic example">
                                                    <button type="button" class="btn btn-warning btn-edit" data-toggle="modal" data-target="#editServis" data-id="{{ $item->id }}"><i class="fas fa-edit"></i></button>
                                                    <form action="{{ route('servis.destroy',$item->id) }}" method="post" id="delete{{ $item->id }}">
                                                        @csrf
                                                        @method('delete')
                                                    <button class="btn btn-danger" type="button" onclick="deleteServis({{ $item->id }})"><i class="fas fa-trash"></i></button>
                                                    </form>
                                                </div>
                                                </td>
                                            </tr>
...
@section('modal')
     {{-- Modal add servis --}}
     <div class="modal fade" id="tambahServis" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('servis.store') }}" method="post" enctype="multipart/form-data"> 
                        ...
                        <div class="form-group">
                            <label for="">Jenis Servis</label>
                            <input type="text" name="jenis_servis" id="jenis_servis" class="form-control" value="{{ old('jenis_servis') }}">
                            @error('jenis_servis')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
